...
public sealed partial class NcContractSystem : EntitySystem
{
    ...
    private List<ContractRewardDef> BuildArtifactStudyRewardDefs(EntityUid store, NcArtifactStudyContractPrototype proto)
    {
    ...
    private bool TryValidateArtifactStudyContractForPool(string packId, NcArtifactStudyContractPrototype proto)
    {
        ...
        {
            Sawmill.Warning($"[Contracts] Pack '{packId}' contains an artifact-study contract with an empty prototype id.");
            return false;
        }
    ...
    private bool TryValidateArtifactStudySpawn(string contractId, NcArtifactStudySpawnData spawn)
    {
        if (spawn.Point == null)
        {
            Sawmill.Warning($"[Contracts] Artifact-study contract '{contractId}' must define spawn.point.");
            return false;
        }
