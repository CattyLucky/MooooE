...
nc-store-contract-drone-hunt-mode-tooltip = После принятия появится вражеский дрон-шаттл. Уничтожьте его AI-ядро и принесите ядро-доказательство.
nc-store-contract-drone-hunt-turn-in-header = Сдать ядро:
nc-store-contract-drone-hunt-turn-in-note = После уничтожения AI-ядра появится доказательство: { $item }. Заберите его и принесите к торговцу.
nc-store-contract-drone-hunt-status-available = Контрактный дрон-шаттл появится после принятия.
nc-store-contract-drone-hunt-status-progress = Уничтожьте AI-ядро дрон-шаттла: { $progress }/{ $required }.
...
nc-store-contract-drone-hunt-action-progress = AI-ядро: { $progress }/{ $required }. Доказательство появится после уничтожения.
nc-store-contract-drone-hunt-action-ready = Сдайте ядро-доказательство торговцу.
nc-store-contract-drone-hunt-target-lost = Контрактный дрон-шаттл потерян до уничтожения AI-ядра. Контракт сорван.
